...
public class PlayerController implements Initializable {
    ...
    private void handleReady() {
        ...
        double currentDuration = duration.toMillis();
        currentText.setText(String.format("%.1f ms", currentDuration));
        currentVisualizer.start(numBands, vizPane);
        timeSlider.setMin(0);
    ...
    @FXML
    private void handlePause(Event event) { //actionevent to event
        if (mediaPlayer != null) {
           mediaPlayer.pause(); 
        }
    }
    ...
    private void handleStop(ActionEvent event) {
        ...
        @FXML
    private void handleSliderDurationUpdate(Event event) {
        if (mediaPlayer != null) {
